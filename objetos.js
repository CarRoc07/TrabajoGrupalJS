...
let _burguesa = new producto (1, 'hamburguesa', 'Ham-burguesa', 1100, 'Clase alta', './img/img-array/burguesa.jpg', false);
...
let _meat = new producto (4, 'hamburguesa', '!Meat', 1260, 'Vegana y poderosa', './img/img-array/meat.jpg',false);
let _peppa = new producto (5, 'hamburguesa', 'Peppa-pig', 1200, 'La cerdita', './img/img-array/peppa.jpg',false);
let _chicken = new producto (6, 'hamburguesa', 'Chicken-little', 1000, 'De pollo y cositas', './img/img-array/chicken.jpg',false);
let _muzza = new producto (7, 'pizza', 'Muzzaraña', 950, 'Muzza inspiradora', './img/img-array/muzza.jpg',false);
...
let _rucula= new producto (11, 'pizza', 'Rucu-jam', 1380, 'Sabor y fiesta', './img/img-array/rucula.jpg',false);
...
let _batido_cherry = new producto (24, 'batido', 'Cherry-bomb', 900, 'Cerecita', './img/img-array/batido-cherry.jpg',true);
let _batido_chocolate = new producto (25, 'batido', 'Chocolate-lover', 900, 'Superclasico', './img/img-array/batido-chocolate.jpg',true);
let _batido_vainilla = new producto (26, 'batido', 'Vanilla-ice', 900, 'Ultra refresh', './img/img-array/batido-vainilla.jpg',false);
let _batido_ddl = new producto (27, 'batido', 'Sweet-heart', 900, 'Bombon de dulce de leche', './img/img-array/batido-ddl.jpg',true);
let _batido_crema = new producto (28, 'batido', 'Creamy', 900, 'Suave y cremoso', './img/img-array/batido-crema.jpg',false);
