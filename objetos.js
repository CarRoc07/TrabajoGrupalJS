...
let _meat = new producto (4, 'hamburguesa', '!Meat', 1260, 'Vegana y poderosa', false);
...
let _muzza = new producto (7, 'pizza', 'Muzzaraña', 950, 'Muzza inspiradora', false);
...
let _rucula= new producto (11, 'pizza', 'Rucu-jam', 1380, 'Sabor y fiesta', false);
...
let _cheddar= new producto (16, 'fritas', 'Cheese-potato', 900, 'Cheddar y mas cheddar', false);
...
let _wrap_carne = new producto (19, 'wraps', 'Meat-wrap', 1100, 'A la antigua', false);
...
let _wrap_vegan = new producto (23, 'wraps', 'Vegan-wrap', 1250, 'Pet friendly', false);
let _batido_cherry = new producto (24, 'batidos', 'Cherry-bomb', 900, 'Cerecita', false);
...
let _batido_ddl = new producto (27, 'batidos', 'Sweet-heart', 900, 'Bombon de dulce de leche', false);
